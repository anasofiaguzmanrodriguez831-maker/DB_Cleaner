...
from oficina
where pais = 'España'; /* Este reto retorna la ciudad y el teléfono de las oficinas ubicadas en España. 
Se usa WHERE para filtrar únicamente los registros cuyo país sea 'España'. */
